...
schema_x_pos(Obj, New):t <- nb1(Obj,Nb1):t, x_size(Nb1):t ~= 1, nb5(Obj,Nb5):t, nothing(Nb5):t ~= yes, nb2(Obj,Nb2):t, nothing(Nb2):t ~= yes, nb7(Obj,Nb7):t, colour(Nb7):t ~= wall, colour(Obj):t ~= agent, action(r), x_pos(Obj):t ~= Curr, New is Curr + 1.
schema_x_pos(Obj, New):t <- nb7(Obj,Nb7):t, nothing(Nb7):t ~= yes, colour(Obj):t ~= agent, action(l), x_pos(Obj):t ~= Curr, New is Curr - 1.
schema_x_pos(Obj, New):t <- nb8(Obj,Nb8):t, nothing(Nb8):t ~= yes, colour(Obj):t ~= agent, action(l), x_pos(Obj):t ~= Curr, New is Curr - 1.
schema_x_pos(Obj, New):t <- nb8(Obj,Nb8):t, nothing(Nb8):t ~= yes, nb4(Obj,Nb4):t, nothing(Nb4):t ~= yes, nb6(Obj,Nb6):t, nothing(Nb6):t ~= yes, action(l), x_pos(Obj):t ~= Curr, New is Curr - 1.
x_pos(Obj):t+1 ~ val(New) <- schema_x_pos(Obj, New):t.
x_pos(Obj):t+1 ~ val(Curr) <- x_pos(Obj):t ~= Curr.
schema_y_pos(Obj, New):t <- colour(Obj):t ~= agent, nb6(Obj,Nb6):t, nothing(Nb6):t ~= yes, action(d), y_pos(Obj):t ~= Curr, New is Curr - 1.
schema_y_pos(Obj, New):t <- nb6(Obj,Nb6):t, colour(Nb6):t ~= hole, action(u), y_pos(Obj):t ~= Curr, New is Curr + 1.
schema_y_pos(Obj, New):t <- nb8(Obj,Nb8):t, nothing(Nb8):t ~= yes, nb1(Obj,Nb1):t, nothing(Nb1):t ~= yes, nb3(Obj,Nb3):t, nothing(Nb3):t ~= yes, nb7(Obj,Nb7):t, x_size(Nb7):t ~= 1, colour(Obj):t ~= agent, action(u), y_pos(Obj):t ~= Curr, New is Curr + 1.
...
% Reward Schemas
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb6(Obj,Nb6):t, colour(Nb6):t ~= hole, action(u).
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb6(Obj,Nb6):t, colour(Nb6):t ~= hole, action(l).
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb6(Obj,Nb6):t, colour(Nb6):t ~= hole, action(r).
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb7(Obj,Nb7):t, nothing(Nb7):t ~= no, nb2(Obj,Nb2):t, nothing(Nb2):t ~= no, nb6(Obj,Nb6):t, nothing(Nb6):t ~= yes.
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb8(Obj,Nb8):t, nothing(Nb8):t ~= yes, nb2(Obj,Nb2):t, nothing(Nb2):t ~= yes, nb5(Obj,Nb5):t, x_size(Nb5):t ~= 1, nb6(Obj,Nb6):t, nothing(Nb6):t ~= yes.
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb1(Obj,Nb1):t, x_size(Nb1):t ~= 1, nb7(Obj,Nb7):t, nothing(Nb7):t ~= yes, nb4(Obj,Nb4):t, colour(Nb4):t ~= wall, nb6(Obj,Nb6):t, x_size(Nb6):t ~= 1, nb5(Obj,Nb5):t, x_size(Nb5):t ~= 1, nb2(Obj,Nb2):t, colour(Nb2):t ~= wall.
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb5(Obj,Nb5):t, colour(Nb5):t ~= wall, nb6(Obj,Nb6):t, nothing(Nb6):t ~= yes, nb7(Obj,Nb7):t, nothing(Nb7):t ~= yes, nb3(Obj,Nb3):t, x_size(Nb3):t ~= 1, nb1(Obj,Nb1):t, colour(Nb1):t ~= wall, nb2(Obj,Nb2):t, colour(Nb2):t ~= wall.
reward:t ~ val(-10) <- constraints:t, changed(Obj), nb7(Obj,Nb7):t, colour(Nb7):t ~= wall, nb2(Obj,Nb2):t, nothing(Nb2):t ~= yes, nb3(Obj,Nb3):t, colour(Nb3):t ~= wall.
reward:t ~ val(-10) <- constraints:t, changed(Obj), nb4(Obj,Nb4):t, nothing(Nb4):t ~= yes, nb5(Obj,Nb5):t, nothing(Nb5):t ~= yes, nb7(Obj,Nb7):t, colour(Nb7):t ~= wall, nb6(Obj,Nb6):t, x_size(Nb6):t ~= 1, nb3(Obj,Nb3):t, nothing(Nb3):t ~= yes, colour(Obj):t ~= agent, nb8(Obj,Nb8):t, colour(Nb8):t ~= wall, action(d).
reward:t ~ val(0) <- true.
...
observation(x_pos(obj19)) ~= 3, observation(y_pos(obj19)) ~= 3, observation(x_size(obj19)) ~= 1, observation(y_size(obj19)) ~= 1, observation(colour(obj19)) ~= agent, observation(shape(obj19)) ~= square, observation(nothing(obj19)) ~= no,
