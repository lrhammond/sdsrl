...
% Actions
adm(action(A)):t <- member(A, [none,l,d,r,u]).
\+(action_performed:0) <- true.
action_performed:t+1 <- action(A), member(A, [none,l,d,r,u]).
...
% Attribute Schemas
schema_x_pos(Obj, New):t <- nb8(Obj):t ~= Nb8, nothing(Nb8):t ~= no, colour(Obj):t ~= agent, action(r), x_pos(Obj):t ~= Curr, New is Curr + 1.
schema_x_pos(Obj, New):t <- nb3(Obj):t ~= Nb3, colour(Nb3):t ~= wall, nb2(Obj):t ~= Nb2, colour(Nb2):t ~= wall, nb6(Obj):t ~= Nb6, nothing(Nb6):t ~= yes, action(r), x_pos(Obj):t ~= Curr, New is Curr + 1.
schema_x_pos(Obj, New):t <- nb1(Obj):t ~= Nb1, nothing(Nb1):t ~= yes, colour(Obj):t ~= agent, action(l), x_pos(Obj):t ~= Curr, New is Curr - 1.
schema_x_pos(Obj, New):t <- nb5(Obj):t ~= Nb5, colour(Nb5):t ~= wall, nb7(Obj):t ~= Nb7, nothing(Nb7):t ~= yes, nb3(Obj):t ~= Nb3, colour(Nb3):t ~= wall, nb2(Obj):t ~= Nb2, colour(Nb2):t ~= wall, nb1(Obj):t ~= Nb1, colour(Nb1):t ~= wall, action(l), x_pos(Obj):t ~= Curr, New is Curr - 1.
x_pos(Obj):t+1 ~ val(New) <- schema_x_pos(Obj, New):t.
x_pos(Obj):t+1 ~ val(Curr) <- x_pos(Obj):t ~= Curr.
schema_y_pos(Obj, New):t <- nb3(Obj):t ~= Nb3, nothing(Nb3):t ~= yes, colour(Obj):t ~= agent, action(d), y_pos(Obj):t ~= Curr, New is Curr - 1.
schema_y_pos(Obj, New):t <- nb1(Obj):t ~= Nb1, x_size(Nb1):t ~= 1, nb8(Obj):t ~= Nb8, nothing(Nb8):t ~= yes, nb3(Obj):t ~= Nb3, colour(Nb3):t ~= wall, nb6(Obj):t ~= Nb6, nothing(Nb6):t ~= yes, action(d), y_pos(Obj):t ~= Curr, New is Curr - 1.
schema_y_pos(Obj, New):t <- nb3(Obj):t ~= Nb3, x_size(Nb3):t ~= 1, nb6(Obj):t ~= Nb6, nothing(Nb6):t ~= yes, nb4(Obj):t ~= Nb4, nothing(Nb4):t ~= yes, nb7(Obj):t ~= Nb7, x_size(Nb7):t ~= 1, colour(Obj):t ~= agent, action(d), y_pos(Obj):t ~= Curr, New is Curr - 1.
schema_y_pos(Obj, New):t <- nb5(Obj):t ~= Nb5, colour(Nb5):t ~= goal, action(u), y_pos(Obj):t ~= Curr, New is Curr + 1.
schema_y_pos(Obj, New):t <- nb7(Obj):t ~= Nb7, nothing(Nb7):t ~= no, nb6(Obj):t ~= Nb6, nothing(Nb6):t ~= no, colour(Obj):t ~= agent, action(u), y_pos(Obj):t ~= Curr, New is Curr + 1.
...
% Reward Schemas
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb5(Obj):t ~= Nb5, nothing(Nb5):t ~= yes, nb7(Obj):t ~= Nb7, colour(Nb7):t ~= wall, nb8(Obj):t ~= Nb8, colour(Nb8):t ~= wall, nb6(Obj):t ~= Nb6, nothing(Nb6):t ~= no, action(l).
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb2(Obj):t ~= Nb2, nothing(Nb2):t ~= yes, nb1(Obj):t ~= Nb1, colour(Nb1):t ~= wall, action(u).
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb2(Obj):t ~= Nb2, nothing(Nb2):t ~= yes, nb1(Obj):t ~= Nb1, colour(Nb1):t ~= wall, action(r).
reward:t ~ val(-10) <- constraints:t, changed(Obj), nb7(Obj):t ~= Nb7, colour(Nb7):t ~= wall, nb6(Obj):t ~= Nb6, x_size(Nb6):t ~= 1, colour(Obj):t ~= agent, action(d).
...
reward:t ~ val(-1) <- constraints:t, changed(Obj), nb3(Obj):t ~= Nb3, x_size(Nb3):t ~= 1, nb7(Obj):t ~= Nb7, nothing(Nb7):t ~= no, nb8(Obj):t ~= Nb8, colour(Nb8):t ~= wall.
