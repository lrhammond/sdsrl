...
main.run(name="ndt3", mode="vgdl", safe=True, numEpisodes=10, numSteps=25, numSamples=50, discount=0.95, horizon=5, deterministic=False, manual_episodes=0, epsilon=0.25)
